...
const ERA_MILESTONES = [
    ...
    { year: 1970, text: "<strong>Drivers & Points:</strong><ul><li>Jochen Rindt (45 Points) - Lotus</li><li>Emerson Fittipaldi (12 Points) - Lotus</li></ul>The Lotus 72 introduced the sidepod radiator concept, which is still the fundamental design for every F1 car today. After leaving Matra, Stewart spent 1970 helping Tyrrell build a new team from scratch. While Lotus dominated this season, Stewart's development work laid the foundation for future championships." }, 
    ...
    { year: 1972, text: "<strong>Drivers & Points:</strong><ul><li>Emerson Fittipaldi (61 Points) - Lotus</li><li>Dave Walker (0 Points) - Lotus</li></ul>Fittipaldi became the youngest champion at the time, showing that the driver/car relationship was shifting toward younger talent. Stewart remained one of Formula One's fastest drivers in 1972, but illness forced him to miss races, allowing Fittipaldi and Lotus to claim the championship." }, 
